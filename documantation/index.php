...
<body>
	...
	<div class="section s1">
		...
		<div class="inner">
			...
			<ol>
				<li><p>Extract <strong>support-theme.zip</strong>.</p></li>
				<li>upload Content of <strong>support-theme</strong> directory to <strong>qa-themes/</strong> directory in your Q2A site</li>
				<li><p>Log in as Administrator, then Go to <strong>Admin &gt; General</strong> and select 'Support-Theme' as your default theme.</p></li>
			...
			<p>to make your site look like <a href="http://demo.qa-themes.com/support/">Theme's demo</a> visit "Admin > Users" and in "Default avatar" section upload an avatar and check it's option button. then in "Avatar size on question lists" field enter '20' and save the form.</p>
		</div>
	</div>

	<div class="section s2">
		<div class="inner">
			<p><strong>Support Theme</strong> offers a wide range of customizations that you can easily apply on your theme.</p>
			...
			<ol>
				...
				<li><strong>Layout:</strong> you can add a <i>Ask Box</i> to header and disable sidebars for certain pages.</li>
				<li><strong>CSS Style Compressions:</strong> you can choose any of CSS compressions</li>
			</ol>			
		</div>
	...
	<div class="section s3">
		...
		<h3>More Backgrounds</h3>
		<p>you have more backgrounds that you want to try on your theme? simply save them as .png files and upload the file in 'qa-plugins/support-plugin/patterns' and it will be added to backgrounds list.</p>
		...
		<p>to add a new CSS file you can upload it in 'qa-theme/support-theme/styles' or you can edit one of pre-made styles.</p>
		</div>
	...
	<div class="section s4">
		<div class="inner">
			...
			<p>if you have suggestion or requests for free themes and plugins you can send them on our <a href="http://idea.qa-themes.com/" title="Q2A Idea and Suggestion box">Idea Box</a> or vote other suggestions and ideas</p>
	...
	<div class="section s5">
		...
		<ul>
			<li><a target="_blank" href="http://subtlepatterns.com/">Subtle Patterns</a> for all backgrounds they provided</li>
